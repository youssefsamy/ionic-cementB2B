...
@Component({
    selector: 'page-support-location-map',
    templateUrl: 'support-location-map.html'
})

export class SupportLocationMap implements OnInit  {
    ...
    constructor(
        ...
        var servicer = this.params.get('servicer');
        this.latitude = servicer.latitude;
        this.longitude = servicer.longitude;
    }
    ...
    ngOnInit() {
        ...
        this.opts = {
            ...
            markers: [{
                ...
                width: 100,
                height: 100,
                icon: 'assets/icon/marker-my.png'
            }],
            geolocationCtrl: {
